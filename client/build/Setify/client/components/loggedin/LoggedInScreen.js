...
function LoggedInScreen() {
    ...
    function renderScreen() {
        if (requestStatus == null) {
            return (react_1.default.createElement(PaginatedForm_1.default, { user: user, mergePlaylists: mergePlaylists }));
        }
        else if (tracks != null && newList != null) {
            return (react_1.default.createElement(ResultSuccess_1.default, { playlistInfo: newList, tracks: tracks, onReset: handleReset }));
        }
        else {
            return (react_1.default.createElement(ResultFail_1.default, null));
        }
    }
    if (user) {
        return (react_1.default.createElement("div", { className: 'logged-in' },
            react_1.default.createElement(UserDropdown_1.default, { username: user.displayName, userID: user.userID }),
            renderScreen()));
    }
    else {
