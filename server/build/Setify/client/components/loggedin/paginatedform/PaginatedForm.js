...
function PaginatedForm(props) {
    ...
    function renderPage() {
        if (pageNum === 1) {
            return (react_1.default.createElement(MethodQuestion_1.default, { onNext: handleNext, onChange: onChange, formData: formData }));
        }
        else if (pageNum === 2) {
            return (react_1.default.createElement(PlaylistQuestion_1.default, { user: props.user, onMerge: onMerge, onPrev: handlePrev, onChange: onChange, formData: formData }));
        }
    }
    function closeError() {
        setError(false);
    ...
    return (react_1.default.createElement("div", null,
        react_1.default.createElement(ErrorPopup_1.default, { open: error, onClose: closeError, text: 'There was a problem submitting the form, please check your inputs' }),
        react_1.default.createElement("form", { className: "container", onSubmit: handleSubmit, id: 'mergeForm' },
            renderPage(),
            react_1.default.createElement("button", { style: { display: 'none' }, type: "submit", id: "submitButton" }))));
}
